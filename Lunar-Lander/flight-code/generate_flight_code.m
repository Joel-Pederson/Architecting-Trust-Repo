...
% It is only typedefs, and the generated code uses exactly three of them, so this function
% substitutes a self-contained equivalent. Without that substitution the artefact cannot
...
" * that lives outside this repository. The generated barrier uses only real_T,", newline, ...
" * boolean_T and int32_T, so they are defined here from <stdint.h> instead. That is what", newline, ...
