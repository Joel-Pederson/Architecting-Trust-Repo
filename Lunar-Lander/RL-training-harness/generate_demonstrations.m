...
%   opts.n_per_phase   - episodes attempted per curriculum phase (default 80)
...
%   demos - struct with .episodes (struct array), .meta, and summary counts
    ...
    if ~isfield(opts,'n_per_phase'), opts.n_per_phase = 80;    end
    ...
    for phase = 1:3
        ...
        fprintf('  phase %d: %d/%d landed\n', phase, ...
            nnz([episodes.phase] == phase), opts.n_per_phase);
    end
